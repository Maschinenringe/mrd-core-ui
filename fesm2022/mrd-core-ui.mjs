...
import { SecurityContext, Injectable, Optional, Inject, EventEmitter, booleanAttribute, Directive, Input, Output, NgModule, numberAttribute, Component, ChangeDetectionStrategy, HostListener, ViewChild, ContentChild, InjectionToken, inject, TemplateRef, forwardRef, ContentChildren, ViewChildren, Injector, ComponentRef, ViewContainerRef, Host } from '@angular/core';
...
class CustomHoverIconDirective {
    /** @nocollapse */ static ɵfac = function CustomHoverIconDirective_Factory(t) { return new (t || CustomHoverIconDirective)(); };
    /** @nocollapse */ static ɵdir = /** @pureOrBreakMyCode */ i0.ɵɵdefineDirective({ type: CustomHoverIconDirective, selectors: [["", "customHoverIcon", ""]] });
}
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(CustomHoverIconDirective, [{
        type: Directive,
        args: [{
                selector: '[customHoverIcon]'
            }]
    }], null, null); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(MrdDirectiveModule, { declarations: [HideIfTruncatedDirective,
        CustomHoverIconDirective], exports: [HideIfTruncatedDirective,
        CustomHoverIconDirective] }); })();
...
const _c1$c = [[["", 3, "mrd-icon", "", 3, "mrd-icon", ""]], [["mrd-icon", "customHoverIcon", ""], ["", "mrd-icon", "", "customHoverIcon", ""]], [["mrd-icon", 3, "customHoverIcon", "", 3, "icon-end", ""], ["", "mrd-icon", "", 3, "customHoverIcon", "", 3, "icon-end", ""]], [["mrd-icon", "customHoverIcon", ""], ["", "mrd-icon", "", "customHoverIcon", ""]], [["mrd-icon", "icon-end", "", 3, "customHoverIcon", ""], ["", "mrd-icon", "", "icon-end", "", 3, "customHoverIcon", ""]]];
...
class MrdButtonComponent extends BasePushStrategyObject {
    ...
    /** @nocollapse */ static ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: MrdButtonComponent, selectors: [["mrd-button"]], contentQueries: function MrdButtonComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            ...
            i0.ɵɵadvance(1);
            i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction1(66, _c4$1, ctx.isCollapsed));
            i0.ɵɵadvance(1);
